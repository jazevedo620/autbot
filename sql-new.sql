...
--
-- Name: tb_active_listeners; Type: TABLE; Schema: public; Owner: autbot
--
...
--
-- Data for Name: tb_active_listeners; Type: TABLE DATA; Schema: public; Owner: autbot
--

COPY public.tb_active_listeners (caller_message_id, target_message_id) FROM stdin;
\.
